...
<Input placeholder=' Explore Payment Networks ' />
</div>
<div className='col-md-4'>
&nbsp;
</div>
...
<Stat>
  <StatLabel> Current Sol Balance </StatLabel>
  <StatNumber> 26,103 SOL</StatNumber>
  <StatHelpText> May 9, 2022</StatHelpText>
</Stat>
</div>
<div className='col-md-12'>
&nbsp;
...
<div className='col-md-12'>
{/* <Text style={{fontFamily:'sans-serif', fontSize:'35px' ,color:'black', fontWeight:'bold'}}> Get Started With A Future Transaction, Adoba </Text> */}
...
<div className='col-md-12'>
            ...
            <div className='col-md-6'>
                    ...
                    <ButtonToolbar>
                 <Button onClick={onOpen}> Create Future Transaction </Button>
                 </ButtonToolbar>
