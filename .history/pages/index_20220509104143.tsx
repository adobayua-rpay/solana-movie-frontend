...
import { Tabs, Divider, SimpleGrid,  Heading,  TabList, TabPanels, Tab, TabPanel, Table, TableCaption, TableContainer, Tbody, Td, Tfoot, Th, Thead, Tr, Badge, Box, Button } from '@chakra-ui/react'
...
<p>
  &nbsp;
        ...
        <Box>
          <Box as='span' color='yellow.300' fontSize='lg'>
            7
          </Box>
          <p>
            &nbsp;
