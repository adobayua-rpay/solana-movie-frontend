...
import { Tabs, Divider,  Heading,  TabList, TabPanels, Tab, TabPanel, Table, TableCaption, TableContainer, Tbody, Td, Tfoot, Th, Thead, Tr, Badge, Box } from '@chakra-ui/react'
